...
You can control:
- **Frequency** — how fast the wave repeats (e.g. once per second vs. ten times per second)
- **Amplitude** — how big the wave is (how high and low the values go)
- **Phase** — where in the cycle the wave starts (most of the time you can leave this at the default)
