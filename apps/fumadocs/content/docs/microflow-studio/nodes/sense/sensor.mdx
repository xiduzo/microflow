---
title: Sensor
description: Use any digital or analog sensor that isn't specifically listed in the documentation.
---
...
- [Rotary Potentiometer](/docs/microflow-studio/nodes/sense/potentiometer)
- [Linear Potentiometer](/docs/microflow-studio/nodes/sense/potentiometer#2-channel-sliding-potentiometer)
- Flex Sensitive Resistor
- Pressure Sensitive Resistor
- [Force Sensitive Resistor](/docs/microflow-studio/nodes/sense/force)
- [Hall Sensor](/docs/microflow-studio/nodes/sense/hall-effect)
- [Tilt Sensor](/docs/microflow-studio/nodes/sense/tilt)
- [Photoresistor/Light Dependent Resistor (LDR)](/docs/microflow-studio/nodes/sense/ldr)
