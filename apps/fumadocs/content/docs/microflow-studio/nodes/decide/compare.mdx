---
title: Compare
description: Check if values meet conditions and route your flow based on true or false results.
---
...
When you want to detect changes or patterns (like "when the value increases by 10") rather than checking exact values, you can use the [`Trigger`](/docs/microflow-studio/nodes/generate/trigger) node instead.
