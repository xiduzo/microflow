  ...
  [
    {
      ...
      answer: 'Bummer, to add support for it you can create a pull request on our <a class="underline" href="https://github.com/xiduzo/microflow-studio" target="_blank">GitHub repository</a> to support it.',
    },
    {
              ...
              <ul role="list" className="flex flex-col gap-y-8">
                {column.map((faq, faqIndex) => (
                  <li key={faqIndex}>
                    ...
                    <p className="mt-4 text-sm text-slate-400" dangerouslySetInnerHTML={{__html: faq.answer}} />
                  </li>
                ))}
              </ul>
            </li>
