...
function CommandDialog({
  ...
  Pick<React.ComponentProps<typeof Command>, "filter"> & {
    title?: string;
    description?: string;
    className?: string;
  ...
  return (
    <Dialog {...props}>
      ...
      <DialogContent
        className={cn("rounded-md overflow-hidden p-0", className)}
...
function CommandInput({
  ...
  return (
    <div data-slot="command-input-wrapper" className="border-b pb-0">
      <InputGroup className="bg-input/30 border-input/30 h-12 border-none shadow-none! *:data-[slot=input-group-addon]:pl-3!">
