...
describe("the stores split out of microflow:app", () => {
  ...
  let sidebar: typeof import("@/shell/sidebar");
  let activeFlow: typeof import("@/flows/active-flow");
  ...
  beforeAll(async () => {
    ...
    sidebar = await import("@/shell/sidebar");
    activeFlow = await import("@/flows/active-flow");
