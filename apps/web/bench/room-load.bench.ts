 ...
 *
 * Run: bun bench/room-load.bench.ts (from apps/web)
 */
...
import { YjsServer, type RoomConnection } from "@microflow/collab/yjs-server";
import { MemoryRoomStore } from "@microflow/collab/room-store";
import { formatRow, header, section } from "./report";
