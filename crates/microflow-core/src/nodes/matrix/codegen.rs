//! Matrix emitter — mirrors `nodes/matrix/runtime.rs`.
//!
...
/// Pin defaults match `nodes/matrix/runtime.rs` (data=2, clock=3, cs=4).
const DEFAULT_DATA: u8 = 2;
const DEFAULT_CLOCK: u8 = 3;
const DEFAULT_CS: u8 = 4;
/// Device-count default matches `nodes/matrix/runtime.rs::default_devices` (1).
