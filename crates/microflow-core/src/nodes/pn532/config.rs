//! PN532 NFC reader config — the single source for the live runtime and any
//! future codegen emitter. Behind `runtime` until that emitter exists (`mod.rs`).
