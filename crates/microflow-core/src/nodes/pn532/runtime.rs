...
//!
//! Unlike the register-mapped sensors behind [`I2cDevice`](crate::nodes::i2c_device::runtime),
...
impl Component for Pn532 {
    ...
    /// register-mapped [`I2cDevice`](crate::nodes::i2c_device::runtime), the PN532 is a
